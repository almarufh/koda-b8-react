...
export default function Header() {
  ...
  return (
    <div className='sticky border border-[#0000001A] border-t-0 rounded-md bg-white shadow-sm top-0 z-50 flex flex-col w-full items-center'>
        <div className="rounded-t-md items-center justify-center w-full hidden md:flex bg-[#1A73E8]">
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-start w-full md:w-[95%] xl:w-[90%] 2xl:w-[80%] p-1 rounded-lg border border-[#0000001A]">
            <div 
            ...
            <Link
                to="https://wa.me/6282393468568"
                target="_blank" 
                className="fixed right-4 top-1/2 z-50 flex items-center justify-center w-fit text-[#25D366] rounded-full"
                >
